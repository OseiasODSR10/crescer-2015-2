...
public class AvaliacaoDao extends BaseDao<Avaliacao>{
	...
	public ArrayList<Avaliacao> buscarPorTurmas(Integer[] ids) throws Exception {
		...
		for(int i=1; i<=ids.length; i++){
			sqlSelect += " OR a.id_turma = ?";
		}
		sqlSelect = sqlSelect + " ORDER BY a.data_avaliacao";	
		try{
			conexao.abrirBanco();
	...
	public ArrayList<Avaliacao> buscarPorTurma(String nome) throws Exception {		
		ArrayList<Avaliacao> avaliacoes = new ArrayList<Avaliacao>();
		String sqlSelect = "SELECT a.id_avaliacao, a.tipo, a.data_avaliacao, a.conteudo, a.disciplina,"
				+ " a.id_turma, t.nome, "
				+ "a.id_Usuario, p.nome "
	...
	public ArrayList<Avaliacao> buscarPorUsuario(int id) throws Exception {		
		ArrayList<Avaliacao> avaliacoes = new ArrayList<Avaliacao>();
		String sqlSelect = "SELECT a.id_avaliacao, a.tipo, a.data_avaliacao, a.conteudo, a.disciplina,"
				+ " a.id_turma, t.nome, "
				+ "a.id_Usuario, p.nome "
